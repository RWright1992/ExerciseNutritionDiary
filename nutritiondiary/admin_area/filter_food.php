...
<body>
    ...
    <div class="flat-form">
      <div class="header">
          ...
          <h1>Admin Area</h1>
            ...
            <div class="block">
            <h2 align= "center">Food Entries</h2><br>
              <table> <!--Table containing food details of particular student-->
                <tr>
                <th>Food_ID</th>
                <th>Name</th>
                <th>Calories (G)</th>
  ...
  $get = "select * from foodentry where user_id like '%$search_query%'"; //Select all from user table where the user_id matches the data from the $search_query
...
//Getting data from the table fields and storing them as arrays
  while($row_pro=mysqli_fetch_array($run)){
      ...
      $food = $row_pro['food'];
      $f_calories = $row_pro['f_calories'];
      $f_fat = $row_pro['f_fat'];
      $f_fatsat = $row_pro['f_fatsat'];
      $f_carb = $row_pro['f_carb'];
      $f_carbsug = $row_pro['f_carbsug'];
      $f_protien = $row_pro['f_protien'];
      $f_salt = $row_pro['f_salt'];
